...
class HighResolutionNet(BaseModel):
    ...
    def __init__(self, num_classes=2, pretrained_backbone=None, **kwargs):
        ...
        self.last_layer = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=last_inp_channels, out_channels=num_classes, kernel_size=extra['FINAL_CONV_KERNEL'], stride=1, 
                    padding=1 if extra['FINAL_CONV_KERNEL'] == 3 else 0)
        )

        self.init_weights(pretrained=pretrained_backbone)
